...
public class Oberflaeche extends javax.swing.JFrame {
    ...
    private class PortConnectionWorker extends ConnectionWorker {
        ...
        protected void done() {
            try{
                get();
                System.out.println("Thread"+ Thread.currentThread().getId() + "beendet");
            }catch(Exception ex){
                ex.printStackTrace();
                JOptionPane.showMessageDialog(Oberflaeche.this, "Fehler", "Fehler beim beenden", JOptionPane.ERROR_MESSAGE);
            }
        }
